...
class SpecialSprite extends Sprite{
	...
	public function noBlur():Void
	{
		addChildAt(new Before(framebuffer1), 0);
		addChild(new After(texture1, new PrimitiveShader(	Assets.getText ("shaders/heroku2.vert"), 
																Assets.getText ("shaders/texture.frag"))
									));
	}

	public function horizontalBlur(): Void
	{
		addChildAt(new Before(framebuffer1), 0);
		addChild(new RenderToTextureLayer(	texture1,
												framebuffer2,
												new PrimitiveShader(Assets.getText ("shaders/heroku2.vert"), 
																		Assets.getText ("shaders/blur.frag"))
											));

		addChild(new After(texture2, new PrimitiveShader(	Assets.getText ("shaders/heroku2.vert"), 
																Assets.getText ("shaders/texture.frag"))
									));
	}

	public function VBlur(): Void
	{
		addChildAt(new Before(framebuffer1), 0);
		addChild(new RenderToTextureLayer(	texture1,
												framebuffer2,
	...
	public function allBlur():Void 
	{
		...
		addChild(new RenderToTextureLayer(	texture2,
												framebuffer1,
												new PrimitiveShader(	Assets.getText ("shaders/heroku2.vert"), 
																		Assets.getText ("shaders/vertblur.frag"))
											));
